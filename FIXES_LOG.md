...
- 2026-01-30: Baseline scheduling now produces >1 batch
  ...
  - Fix: remove baseline gating from `lib/dependency-analyzer.sh`; keep gating decisions in the runner (`raffaello.sh`) after computing the real execution plan.
...
- 2026-01-30: Claude Code only (simplified CLI support)
  - Removed legacy CLI references and simplified to Claude Code only.
